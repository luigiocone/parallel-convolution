...
uint coordinator_nrows;               // Subpart of load_balancer rows that coordinator should compute
...
void initialize_thread_coordinates(struct thread_handler* handler) {
  ...
  const int fixed_size = nrows_per_thread * grid_width;
